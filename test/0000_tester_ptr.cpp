...
int main() {
    ...
    tester.expectException<TestException>([] {
        Tester t("nullptr check", ThrowExceptionOnError);
        t.assertNotNull(nullptr, "nullptr should throw");
    });
    ...
    tester.expectException<TestException>([] {
        ...
        Tester t("null shared_ptr", ThrowExceptionOnError);
        t.assertNotNull(p, "null shared_ptr should throw");
    });
    ...
    tester.expectException<TestException>([] {
        ...
        Tester t("null weak_ptr", ThrowExceptionOnError);
        t.assertNotNull(wp, "null weak_ptr should throw");
    });
